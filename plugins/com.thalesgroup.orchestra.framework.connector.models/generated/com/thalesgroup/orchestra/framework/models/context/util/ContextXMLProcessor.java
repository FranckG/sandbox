 ...
 * @generated
 */
public class ContextXMLProcessor extends XMLProcessor {
  ...
  protected Map<String, Resource.Factory> getRegistrations() {
    if (registrations == null) {
      ...
      registrations.put(XML_EXTENSION, new ContextResourceFactoryImpl());
      registrations.put(STAR_EXTENSION, new ContextResourceFactoryImpl());
    }
