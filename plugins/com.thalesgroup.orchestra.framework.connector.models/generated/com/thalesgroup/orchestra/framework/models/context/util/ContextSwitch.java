...
public class ContextSwitch<T> extends Switch<T> {
  ...
  protected T doSwitch(int classifierID, EObject theEObject) {
    switch (classifierID) {
      ...
      case ContextPackage.CONTEXT_DEFINITION: {
        ContextDefinition contextDefinition = (ContextDefinition)theEObject;
        T result = caseContextDefinition(contextDefinition);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ContextPackage.DOCUMENT_ROOT: {
        DocumentRoot documentRoot = (DocumentRoot)theEObject;
        T result = caseDocumentRoot(documentRoot);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ContextPackage.ENVIRONMENT_PROPERTY: {
        EnvironmentProperty environmentProperty = (EnvironmentProperty)theEObject;
        T result = caseEnvironmentProperty(environmentProperty);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Environment Property</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Environment Property</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseEnvironmentProperty(EnvironmentProperty object) {
    return null;
  }
