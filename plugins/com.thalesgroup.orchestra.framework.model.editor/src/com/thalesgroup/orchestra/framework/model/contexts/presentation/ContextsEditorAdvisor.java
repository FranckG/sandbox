...
import com.thalesgroup.orchestra.framework.model.contexts.presentation.ContextsEditorPlugin;
 ...
 * @generated
 */
public final class ContextsEditorAdvisor extends WorkbenchAdvisor {
  /**
   ...
   * @generated
   */
  private static final String[] FILE_EXTENSION_FILTERS = ContextsEditor.FILE_EXTENSION_FILTERS.toArray(new String[0]);
  ...
  private static String getString(String key) {
    return ContextsEditorPlugin.INSTANCE.getString(key);
  }
  ...
  private static String getString(String key, Object s1) {
    return com.thalesgroup.orchestra.framework.model.contexts.presentation.ContextsEditorPlugin.INSTANCE.getString(key, new Object [] { s1 });
  }
  ...
  public static class Application implements IApplication {
    ...
    public Object start(IApplicationContext context) throws Exception {
      WorkbenchAdvisor workbenchAdvisor = new ContextsEditorAdvisor();
  ...
  public static class Perspective implements IPerspectiveFactory {
     ...
     * @generated
     */
    public static final String ID_PERSPECTIVE = "com.thalesgroup.orchestra.framework.model.contexts.presentation.ContextsEditorAdvisorPerspective";
  ...
  /**
   * Open action for the objects from the Contexts model.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  /**
   * Open URI action for the objects from the Contexts model.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
