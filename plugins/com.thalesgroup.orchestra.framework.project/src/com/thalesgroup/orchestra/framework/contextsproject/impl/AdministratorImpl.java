 ...
 * <ul>
 *   <li>{@link com.thalesgroup.orchestra.framework.contextsproject.impl.AdministratorImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AdministratorImpl extends EObjectImpl implements Administrator {
  ...
  protected EClass eStaticClass() {
    return ContextsProjectPackage.Literals.ADMINISTRATOR;
  }
  ...
  public void setId(String newId) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ContextsProjectPackage.ADMINISTRATOR__ID, oldId, id));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
      case ContextsProjectPackage.ADMINISTRATOR__ID:
        return getId();
    }
