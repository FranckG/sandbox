 ...
 */
// TODO Guillaume
// Make it common with orchestra.framework.common through an orchestra.framework.root bundle.
// The root bundle should not depend on EMF or advanced features.
public class ExtensionPointHelper {
  ...
  public static Object createExecutableExtension(String pluginId_p, String extensionPointId_p, String attributeId_p, String attributeValue_p) {
    ...
    if (configElements.length == 0) {
      ...
      EcfServicesActivator.getInstance().logMessage(loggerMessage.toString(), IStatus.WARNING, null);
    } else {
  ...
  public static Object createInstance(IConfigurationElement configurationElement_p, String attributeName_p) {
    ...
    try {
      ...
      EcfServicesActivator.getInstance().logMessage(loggerMessage.toString(), IStatus.WARNING, exception_p);
    }
    return typeInstance;
  }
   ...
   */
  public static Integer getValue(IConfigurationElement element_p, String attributeName_p) {
    // Precondition.
