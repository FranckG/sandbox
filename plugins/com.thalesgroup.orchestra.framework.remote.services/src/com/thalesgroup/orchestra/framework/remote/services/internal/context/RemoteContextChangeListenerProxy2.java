 ...
 * @author t0076261
 */
public class RemoteContextChangeListenerProxy2 implements IRemoteContextChangeListenerProxy2 {
  /**
   * Serial UID.
   */
  private static final long serialVersionUID = 3617271644120477355L;

  /**
   * Real listener implementation.
   */
  private IRemoteContextChangeListener2 _listener;
  /**
   ...
   */
  public RemoteContextChangeListenerProxy2(IRemoteContextChangeListener2 listener_p) {
   ...
   */
  public String postContextChange(String contextName_p, boolean allowUserInteractions_p) {
    return _serializationHelper.serializeStatus(_listener.postContextChange(contextName_p, allowUserInteractions_p));
  }
