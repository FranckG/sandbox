...
/**
 * An {@link IControlContentAdapter} for SWT CCombo controls. This is a convenience class for easily creating a {@link ContentProposalAdapter} for custom combo
 * fields.
 * @since 3.2
 */
public class ComboContentAdapter implements IControlContentAdapter, IControlContentAdapter2 {
  ...
  /*
   * Set to <code>true</code> if we should compute the text vertical bounds rather than just use the field size. Workaround for
   * https://bugs.eclipse.org/bugs/show_bug.cgi?id=164748 The corresponding SWT bug is https://bugs.eclipse.org/bugs/show_bug.cgi?id=44072
   */
