/*******************************************************************************
 * Copyright (c) 2004, 2007 IBM Corporation and others. All rights reserved. This program and the accompanying materials are made available under the terms of
 * the Eclipse Public License v1.0 which accompanies this distribution, and is available at http://www.eclipse.org/legal/epl-v10.html Contributors: IBM
...
public class PatternFilter extends ViewerFilter {
   ...
   * Listeners list.
   */
  private List<IPatternFilterListener> _listeners;

  /**
   * Constructor.
   */
  public PatternFilter() {
    _listeners = new ArrayList<IPatternFilterListener>(0);
  }

  /**
   * Add a new {@link IPatternFilterListener}.<br>
   * Note that the listener is not added to the list of listeners if it is already contained in this list.
   * @param listener_p
   */
  public void addListener(IPatternFilterListener listener_p) {
  ...
  /**
   * Should specified label be highlighted ?
   * @param label_p
   * @return
   */
  public boolean highlightLabel(String label_p) {
    return (null != matcher) && wordMatches(label_p);
  }
  ...
  /**
   * Remove specified {@link IPatternFilterListener}.
   * @param listener_p
   */
  public void removeListener(IPatternFilterListener listener_p) {
  ...
  public final void setIncludeLeadingWildcard(final boolean includeLeadingWildcard_p) {
    this.includeLeadingWildcard = includeLeadingWildcard_p;
  }
  ...
  public void setPattern(String patternString) {
    ...
    // Notify listeners.
    for (IPatternFilterListener listener : _listeners) {
      listener.patternChanged(patternString);
    }
  }

  /**
   * Can be called by the filtered tree to turn on caching.
   * @param useCache_p The useCache to set.
   */
  public void setUseCache(boolean useCache_p) {
    this.useCache = useCache_p;
  }
