...
public class ConnectorWSAdapterServiceLocator extends org.apache.axis.client.Service implements com.thalesgroup.orchestra.framework.webservices.connector.ConnectorWSAdapterService {
    ...
    public com.thalesgroup.orchestra.framework.webservices.connector.ConnectorWSAdapter getconnector(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.thalesgroup.orchestra.framework.webservices.connector.ConnectorSoapBindingStub _stub = new com.thalesgroup.orchestra.framework.webservices.connector.ConnectorSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.thalesgroup.orchestra.framework.webservices.connector.ConnectorWSAdapter.class.isAssignableFrom(serviceEndpointInterface)) {
                com.thalesgroup.orchestra.framework.webservices.connector.ConnectorSoapBindingStub _stub = new com.thalesgroup.orchestra.framework.webservices.connector.ConnectorSoapBindingStub(new java.net.URL(connector_address), this);
                _stub.setPortName(getconnectorWSDDServiceName());
                return _stub;
            }
        }
