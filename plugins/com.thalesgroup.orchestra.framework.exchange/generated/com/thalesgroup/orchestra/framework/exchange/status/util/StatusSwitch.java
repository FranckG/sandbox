...
public class StatusSwitch<T> extends Switch<T> {
  ...
  protected T doSwitch(int classifierID, EObject theEObject) {
    switch (classifierID) {
      case StatusPackage.DOCUMENT_ROOT: {
      ...
      case StatusPackage.STATUS_DEFINITION: {
        StatusDefinition statusDefinition = (StatusDefinition)theEObject;
        T result = caseStatusDefinition(statusDefinition);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
   ...
   * @generated
   */
  public T caseStatusDefinition(StatusDefinition object) {
    return null;
  }
