...
public class StatusAdapterFactory extends AdapterFactoryImpl {
  ...
  protected StatusSwitch<Adapter> modelSwitch =
    new StatusSwitch<Adapter>() {
      ...
      @Override
      public Adapter caseStatusDefinition(StatusDefinition object) {
        return createStatusDefinitionAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link com.thalesgroup.orchestra.framework.exchange.status.DocumentRoot <em>Document Root</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link com.thalesgroup.orchestra.framework.exchange.status.Status <em>Status</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link com.thalesgroup.orchestra.framework.exchange.status.StatusDefinition <em>Definition</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createStatusDefinitionAdapter() {
    return null;
  }
