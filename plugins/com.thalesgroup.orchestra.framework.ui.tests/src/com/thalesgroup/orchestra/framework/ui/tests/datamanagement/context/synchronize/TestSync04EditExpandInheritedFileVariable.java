 ...
 * @author t0122040
 */
public class TestSync04EditExpandInheritedFileVariable extends SynchronizeContextTests {

  @SuppressWarnings("all")
  @Test
  public void test() throws Exception {
    // testAddNewElementsInParentContextAndSynchronize
    // testChangeElementsNameInParentContextAndSynchronize();
    // testEditExpandInheritedCategory();
    testEditExpandInheritedFileVariable();
  }
}
