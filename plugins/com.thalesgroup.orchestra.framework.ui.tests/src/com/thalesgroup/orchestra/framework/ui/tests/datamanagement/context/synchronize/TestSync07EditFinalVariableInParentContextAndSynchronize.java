 ...
 * @author t0122040
 */
public class TestSync07EditFinalVariableInParentContextAndSynchronize extends SynchronizeContextTests {

  @SuppressWarnings("all")
  @Test
  public void test() throws Exception {
    testEditFinalVariableInParentContextAndSynchronize();
  }
}
